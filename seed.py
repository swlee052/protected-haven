...
english = Lang(name='English', script='English', form_name='Your Name', form_email='Your Email Address', form_phone='Your Phone Number', form_details='Details of the Incident', form_geoloc="Do not send geolocation")
